...
#'
deletion_mutator <- function(nt_sequence, deletion_rate_A = 0.05, deletion_rate_T = 0.05, deletion_rate_C = 0.05, deletion_rate_G = 0.05) {
    .Call(`_evolution_deletion_mutator`, nt_sequence, deletion_rate_A, deletion_rate_T, deletion_rate_C, deletion_rate_G)
}
...
#' @useDynLib evolution, .registration = TRUE
#'
find_start_codon <- function(nt_sequence) {
    .Call(`_evolution_find_start_codon`, nt_sequence)
}
...
#' @useDynLib evolution, .registration = TRUE
#'
find_stop_codon <- function(nt_sequence) {
    .Call(`_evolution_find_stop_codon`, nt_sequence)
}
...
#' @useDynLib evolution, .registration = TRUE
#'
insertion_mutator <- function(nt_sequence, insertion_rate_A = 0.05, insertion_rate_T = 0.05, insertion_rate_C = 0.05, insertion_rate_G = 0.05) {
    .Call(`_evolution_insertion_mutator`, nt_sequence, insertion_rate_A, insertion_rate_T, insertion_rate_C, insertion_rate_G)
}
...
#' @useDynLib evolution, .registration = TRUE
#'
substitution_mutator <- function(nt_sequence, sub_rate_A_to_T = 0.05, sub_rate_A_to_C = 0.05, sub_rate_A_to_G = 0.05, sub_rate_T_to_A = 0.05, sub_rate_T_to_C = 0.05, sub_rate_T_to_G = 0.05, sub_rate_C_to_A = 0.05, sub_rate_C_to_T = 0.05, sub_rate_C_to_G = 0.05, sub_rate_G_to_A = 0.05, sub_rate_G_to_T = 0.05, sub_rate_G_to_C = 0.05) {
    .Call(`_evolution_substitution_mutator`, nt_sequence, sub_rate_A_to_T, sub_rate_A_to_C, sub_rate_A_to_G, sub_rate_T_to_A, sub_rate_T_to_C, sub_rate_T_to_G, sub_rate_C_to_A, sub_rate_C_to_T, sub_rate_C_to_G, sub_rate_G_to_A, sub_rate_G_to_T, sub_rate_G_to_C)
}
...
#' @useDynLib evolution, .registration = TRUE
#'
translate <- function(nt_sequence, check_start_and_stop = FALSE) {
    .Call(`_evolution_translate`, nt_sequence, check_start_and_stop)
}
